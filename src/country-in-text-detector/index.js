...
function detect(str) {
  ...
  for (var i = 0; i < COUNTRIES.length; i++) {
    ...
    if (!(typeof matches === "undefined" || matches === null)) {
      ...
      result.push({
        iso3166_alpha2: COUNTRIES[i]["country_iso_3166-1_alpha-2"],
        iso3166_alpha3: COUNTRIES[i]["country_iso_3166-1_alpha-3"],
  ...
  for (var i = 0; i < CITIES.length; i++) {
    ...
    if (!(typeof matches === "undefined" || matches === null)) {
      ...
      result.push({
        iso3166_alpha2: CITIES[i]["country_iso_3166-1_alpha-2"],
        iso3166_alpha3: CITIES[i]["country_iso_3166-1_alpha-3"],
